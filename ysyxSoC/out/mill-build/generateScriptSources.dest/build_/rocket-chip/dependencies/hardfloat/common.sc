package build_.`rocket-chip`.dependencies.hardfloat
import _root_.{build_ => $file}
import build_.{package_ => build}
object common {
//MILL_ORIGINAL_FILE_PATH=/home/hjw-arch/ysyx-workbench/ysyxSoC/rocket-chip/dependencies/hardfloat/common.sc
